...
public class EmployeeRegister implements Initializable {
    ...
    public void registerButtonOnAction(ActionEvent event) throws IOException, NoSuchPaddingException, InvalidAlgorithmParameterException, NoSuchAlgorithmException {
        if(passwordTextField.getText().equals(confirmPasswordTextField.getText())){
            ...
            String insertFields = "INSERT into employeeaccount(Name,Password,Email,Telephone,Adress) VALUES ('";
            ...
            try {
                ...
                alert.setContentText("The Employee has been registered successfully.");
                alert.showAndWait();
